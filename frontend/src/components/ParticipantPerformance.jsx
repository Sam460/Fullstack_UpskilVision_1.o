...
// ✅ Required for Vite compatibility with Chart.js
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
    ...
    <div className="users-section">
      ...
      <div className="stats-overview">
        <div className="stat-card">
          ...
          <span className="stat-value">{getFilteredStats().averagePerformance}%</span>
        </div>
        <div className="stat-card">
        ...
        <div className="stat-card">
          ...
          <span className="stat-value">{getFilteredStats().highPerformers}</span>
        </div>
      </div>
          ...
          <tbody>
            {filteredParticipants.map(participant => (
              <tr key={participant.id}>
                ...
                <td>
                  <span className={`status-badge ${getPerformanceLabel(participant.overallScore).toLowerCase()}`}>
